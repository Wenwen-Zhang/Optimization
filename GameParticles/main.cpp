...
// ASSUME SSE4.1 is the highest level on the test machine
...
int main (int argc, char * const argv[])
{
	...
	// Get the inverse Camera Matrix:-------------------
		...
		Matrix TransMatrix;
		TransMatrix.setTransMatrix(0.0f, 3.0f, 10.0f);

		// get the inverse matrix
		Matrix inverseCameraMatrix = CameraMatrix * TransMatrix;
		inverseCameraMatrix.getInverse();
